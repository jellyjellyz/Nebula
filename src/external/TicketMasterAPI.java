...
public class TicketMasterAPI {
    ...
    private static final String API_KEY = "OA55UVixOhWEssK18uyhowv1a8Lz8dlH";
    ...
    public List<Item> search(double lat, double lon, String keyword) {
        ...
        try {
            ...
            // try with resource, could auto close the file after operation
    ...
    private void queryAPI(double lat, double lon) {  //for testing
